                ...
                <Card>
                    <CardContent>
                        <div className="text-center mb-8">
                            <h1 className="text-2xl font-semibold text-[#0F172A] mb-2 font-[Lora]">Welcome Back</h1>
                            <p className="text-[#475569] font-[Lexend]">Sign in to continue your practice</p>
                        </div>
                        ...
                        <div className="relative my-8">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-white text-[#94A3B8] font-[Lexend]">or continue with</span>
                            </div>
                        </div>
