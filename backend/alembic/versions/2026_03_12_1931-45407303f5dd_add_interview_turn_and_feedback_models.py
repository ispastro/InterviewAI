...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False, comment='Unique identifier for this user'),
    sa.Column('email', sa.String(length=255), nullable=False, comment='User email address'),
    sa.Column('name', sa.String(length=255), nullable=True, comment='User full name'),
    sa.Column('oauth_provider', sa.String(length=50), nullable=True, comment='OAuth provider (google, github, etc.)'),
    sa.Column('oauth_subject', sa.String(length=255), nullable=True, comment='OAuth provider user ID'),
    sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true', comment='Whether user account is active'),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, comment='When this user was created'),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, comment='When this user was last updated'),
